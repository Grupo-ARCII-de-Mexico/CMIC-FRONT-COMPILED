...
const Toggle = class {
  constructor(hostRef) {
    ...
    this.setupGesture = /*#__PURE__*/(0,C_Users_darka_OneDrive_Documentos_PRIVADOS_generic_admin_system_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const {
        toggleTrack
      } = _this;
      if (toggleTrack) {
