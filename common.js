...
/* harmony import */ var _tools_toast_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../tools/toast.service */ 5428);
/* harmony import */ var _tools_loading_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../tools/loading.service */ 7153);
...
class ErrorService {
  ...
  catchError(error) {
    ...
    return (0,C_Users_darka_OneDrive_Documentos_PRIVADOS_generic_admin_system_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      _this.toast.setData({
        animated: true,
        color: error.status === 401 ? 'warning' : 'danger',
        message: error.status === 401 ? 'Revisa tus credenciales' : 'Sucedió un error intente más tarde',
        duration: 3000
      });
      yield _this.toast.create();
      yield _this.toast.show();
...
_class = ErrorService;
_class.ɵfac = function ErrorService_Factory(t) {
  return new (t || _class)(_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵinject"](_tools_toast_service__WEBPACK_IMPORTED_MODULE_1__.ToastService), _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵinject"](_tools_loading_service__WEBPACK_IMPORTED_MODULE_2__.LoadingService));
};
...
class GenericService {
  ...
  updateWhitImage(ruta, id, data) {
    return this.http.patch(this.Uri + ruta + '/' + id, data);
  }
  post(ruta, data) {
    return this.http.post(this.Uri + ruta, data);
  }
  postWhitImage(ruta, data) {
    return this.http.post(this.Uri + ruta, data);
  }
}
_class = GenericService;
_class.ɵfac = function GenericService_Factory(t) {
...
/***/ 7153:
/*!*************************************************!*\
  !*** ./src/app/shared/tools/loading.service.ts ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
class LoadingService {
  ...
  create() {
    var _this = this;
    return (0,C_Users_darka_OneDrive_Documentos_PRIVADOS_generic_admin_system_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      _this.loading = yield _this.loadingS.create({
        ..._this.loadingOptions
      });
    })();
  }
  show() {
  ...
  setData(loadingOptions) {
    var _this4 = this;
    return (0,C_Users_darka_OneDrive_Documentos_PRIVADOS_generic_admin_system_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      _this4.loadingOptions = loadingOptions;
    })();
  }
}
_class = LoadingService;
_class.ɵfac = function LoadingService_Factory(t) {
  return new (t || _class)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_ionic_angular__WEBPACK_IMPORTED_MODULE_2__.LoadingController));
};
_class.ɵprov = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjectable"]({
  token: _class,
  factory: _class.ɵfac,
...
/***/ 5428:
/*!***********************************************!*\
  !*** ./src/app/shared/tools/toast.service.ts ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
class ToastService {
  ...
  create() {
    var _this = this;
    return (0,C_Users_darka_OneDrive_Documentos_PRIVADOS_generic_admin_system_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      _this.toast = yield _this.toastS.create({
        ..._this.toastOptions
      });
    })();
  }
  show() {
    var _this2 = this;
    return (0,C_Users_darka_OneDrive_Documentos_PRIVADOS_generic_admin_system_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      yield _this2.toast.present();
    })();
  }
  hide() {
    var _this3 = this;
    return (0,C_Users_darka_OneDrive_Documentos_PRIVADOS_generic_admin_system_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      yield _this3.toast.dismiss();
    })();
  }
  setData(toastOptions) {
    this.toastOptions = toastOptions;
  }
}
_class = ToastService;
_class.ɵfac = function ToastService_Factory(t) {
  return new (t || _class)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_ionic_angular__WEBPACK_IMPORTED_MODULE_2__.ToastController));
};
_class.ɵprov = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjectable"]({
  token: _class,
  factory: _class.ɵfac,
...
const getScrollElement = /*#__PURE__*/function () {
  var _ref = (0,C_Users_darka_OneDrive_Documentos_PRIVADOS_generic_admin_system_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el) {
    if (isIonContent(el)) {
...
const createKeyboardController = /*#__PURE__*/function () {
  var _ref = (0,C_Users_darka_OneDrive_Documentos_PRIVADOS_generic_admin_system_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (keyboardChangeCallback) {
...
const createLockController = () => {
  ...
  const lock = /*#__PURE__*/function () {
    var _ref = (0,C_Users_darka_OneDrive_Documentos_PRIVADOS_generic_admin_system_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const p = waitPromise;
      let resolve;
